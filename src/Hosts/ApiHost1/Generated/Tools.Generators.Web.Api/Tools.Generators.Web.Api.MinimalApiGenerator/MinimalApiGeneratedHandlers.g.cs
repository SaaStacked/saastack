    ...
    public static class MinimalApiRegistration
    {
        public static void RegisterRoutes(this global::Microsoft.AspNetCore.Builder.WebApplication app)
        {
            ...
            healthapiGroup.MapGet("/health",
                async (global::System.IServiceProvider serviceProvider, global::Infrastructure.Web.Api.Operations.Shared.ApiHosts.ApiHealthCheckRequest request) =>
                {
                    return await Handle(serviceProvider, request, global::System.Threading.CancellationToken.None);

                    static async Task<global::Microsoft.AspNetCore.Http.IResult> Handle(global::System.IServiceProvider services, global::Infrastructure.Web.Api.Operations.Shared.ApiHosts.ApiHealthCheckRequest request, global::System.Threading.CancellationToken cancellationToken)
                    {
                        var webHostOptions = services.GetRequiredService<global::Infrastructure.Web.Hosting.Common.WebHostOptions>();

                        var api = new global::ApiHost1.Api.Health.HealthApi(webHostOptions);
                ...
                .AddEndpointFilter<global::Infrastructure.Web.Api.Common.Endpoints.ValidationFilter<global::Infrastructure.Web.Api.Operations.Shared.ApiHosts.ApiHealthCheckRequest>>()
                .WithOpenApi(op =>
                    {
                        op.OperationId = "ApiHealthCheck";
                        op.Description = "(request type: ApiHealthCheckRequest)";
                        op.Responses.Clear();
                        return op;
                    });
        var statsapiGroup = app.MapGroup(string.Empty)
                .WithTags("StatsApi")
                .RequireCors("__DefaultCorsPolicy")
                .AddEndpointFilter<global::Infrastructure.Web.Api.Common.Endpoints.HttpRecordingFilter>()
                .AddEndpointFilter<global::Infrastructure.Web.Api.Common.Endpoints.ApiUsageFilter>()
                .AddEndpointFilter<global::Infrastructure.Web.Api.Common.Endpoints.RequestCorrelationFilter>()
                .AddEndpointFilter<global::Infrastructure.Web.Api.Common.Endpoints.ContentNegotiationFilter>();
            statsapiGroup.MapGet("/stats",
                async (global::System.IServiceProvider serviceProvider, global::Infrastructure.Web.Api.Operations.Shared.ApiHosts.ApiStatisticsRequest request) =>
                {
                    return await Handle(serviceProvider, request, global::System.Threading.CancellationToken.None);

                    static async Task<global::Microsoft.AspNetCore.Http.IResult> Handle(global::System.IServiceProvider services, global::Infrastructure.Web.Api.Operations.Shared.ApiHosts.ApiStatisticsRequest request, global::System.Threading.CancellationToken cancellationToken)
                    {
                        var httpContextAccessor = services.GetRequiredService<global::Microsoft.AspNetCore.Http.IHttpContextAccessor>();
                        var webHostOptions = services.GetRequiredService<global::Infrastructure.Web.Hosting.Common.WebHostOptions>();
                        var swaggerProvider = services.GetRequiredService<global::Swashbuckle.AspNetCore.Swagger.ISwaggerProvider>();

                        var api = new global::ApiHost1.Api.Health.StatsApi(httpContextAccessor, webHostOptions, swaggerProvider);
                        var result = await api.Stats(request, cancellationToken);
                        return result.HandleApiResult(global::Infrastructure.Web.Api.Interfaces.OperationMethod.Get);
                    }
                })
                .RequireAuthorization("Anonymous")
                .AddEndpointFilter<global::Infrastructure.Web.Api.Common.Endpoints.ValidationFilter<global::Infrastructure.Web.Api.Operations.Shared.ApiHosts.ApiStatisticsRequest>>()
                .WithOpenApi(op =>
                    {
                        op.OperationId = "ApiStatistics";
                        op.Description = "(request type: ApiStatisticsRequest)";
                        op.Responses.Clear();
                        return op;
                    });
