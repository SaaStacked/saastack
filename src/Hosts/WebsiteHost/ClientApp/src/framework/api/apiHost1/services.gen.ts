 ...
 * (request type: FakeBillingProviderNotifyWebHookEventRequest)
 */
export const fakeBillingProviderNotifyWebHookEvent = <ThrowOnError extends boolean = false>(
  options?: Options<FakeBillingProviderNotifyWebHookEventData, ThrowOnError>
) =>
  (options?.client ?? client).post<
    FakeBillingProviderNotifyWebHookEventResponse,
    FakeBillingProviderNotifyWebHookEventError,
    ThrowOnError
  >({
    ...options,
    url: '/webhooks/billingproviders/fake'
  });
