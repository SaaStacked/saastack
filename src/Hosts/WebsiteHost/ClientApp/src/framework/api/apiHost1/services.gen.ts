...
import { createClient, createConfig, formDataBodySerializer, urlSearchParamsBodySerializer, type Options } from '@hey-api/client-axios';
import type { AssignPlatformRolesData, AssignPlatformRolesError, AssignPlatformRolesResponse, AssignRolesToOrganizationPatchData, AssignRolesToOrganizationPatchError, AssignRolesToOrganizationPatchResponse, AssignRolesToOrganizationPutData, AssignRolesToOrganizationPutError, AssignRolesToOrganizationPutResponse, AssociateCredentialMfaAuthenticatorForCallerData, AssociateCredentialMfaAuthenticatorForCallerError, AssociateCredentialMfaAuthenticatorForCallerResponse2, AuthenticateCredentialData, AuthenticateCredentialError, AuthenticateCredentialResponse, AuthenticateSingleSignOnData, AuthenticateSingleSignOnError, AuthenticateSingleSignOnResponse, AuthorizeByAnonymousTestingOnlyError, AuthorizeByAnonymousTestingOnlyResponse, AuthorizeByFeatureTestingOnlyError, AuthorizeByFeatureTestingOnlyResponse, AuthorizeByTokenWithRoleTestingOnlyError, AuthorizeByTokenWithRoleTestingOnlyResponse, AuthorizeOauth2GetData, AuthorizeOauth2GetError, AuthorizeOauth2GetResponse, AuthorizeOauth2PostData, AuthorizeOauth2PostError, AuthorizeOauth2PostResponse, CancelBookingData, CancelBookingError, CancelBookingResponse, CancelSubscriptionData, CancelSubscriptionError, CancelSubscriptionResponse, ChallengeCredentialMfaAuthenticatorForCallerPatchData, ChallengeCredentialMfaAuthenticatorForCallerPatchError, ChallengeCredentialMfaAuthenticatorForCallerPatchResponse, ChallengeCredentialMfaAuthenticatorForCallerPutData, ChallengeCredentialMfaAuthenticatorForCallerPutError, ChallengeCredentialMfaAuthenticatorForCallerPutResponse, ChangeCredentialMfaForCallerPatchData, ChangeCredentialMfaForCallerPatchError, ChangeCredentialMfaForCallerPatchResponse, ChangeCredentialMfaForCallerPutData, ChangeCredentialMfaForCallerPutError, ChangeCredentialMfaForCallerPutResponse, ChangeDefaultOrganizationPatchData, ChangeDefaultOrganizationPatchError, ChangeDefaultOrganizationPatchResponse, ChangeDefaultOrganizationPutData, ChangeDefaultOrganizationPutError, ChangeDefaultOrganizationPutResponse, ChangeOrganizationAvatarPatchData, ChangeOrganizationAvatarPatchError, ChangeOrganizationAvatarPatchResponse, ChangeOrganizationAvatarPutData, ChangeOrganizationAvatarPutError, ChangeOrganizationAvatarPutResponse, ChangeOrganizationPatchData, ChangeOrganizationPatchError, ChangeOrganizationPatchResponse, ChangeOrganizationPutData, ChangeOrganizationPutError, ChangeOrganizationPutResponse, ChangeProfileAvatarPatchData, ChangeProfileAvatarPatchError, ChangeProfileAvatarPatchResponse, ChangeProfileAvatarPutData, ChangeProfileAvatarPutError, ChangeProfileAvatarPutResponse, ChangeProfileContactAddressPatchData, ChangeProfileContactAddressPatchError, ChangeProfileContactAddressPatchResponse, ChangeProfileContactAddressPutData, ChangeProfileContactAddressPutError, ChangeProfileContactAddressPutResponse, ChangeProfilePatchData, ChangeProfilePatchError, ChangeProfilePatchResponse, ChangeProfilePutData, ChangeProfilePutError, ChangeProfilePutResponse, ChangeSubscriptionPlanPatchData, ChangeSubscriptionPlanPatchError, ChangeSubscriptionPlanPatchResponse, ChangeSubscriptionPlanPutData, ChangeSubscriptionPlanPutError, ChangeSubscriptionPlanPutResponse, CompleteCredentialResetData, CompleteCredentialResetError, CompleteCredentialResetResponse, ConfirmCredentialMfaAuthenticatorForCallerPatchData, ConfirmCredentialMfaAuthenticatorForCallerPatchError, ConfirmCredentialMfaAuthenticatorForCallerPatchResponse, ConfirmCredentialMfaAuthenticatorForCallerPutData, ConfirmCredentialMfaAuthenticatorForCallerPutError, ConfirmCredentialMfaAuthenticatorForCallerPutResponse, ConfirmEmailDeliveredData, ConfirmEmailDeliveredError, ConfirmEmailDeliveredResponse, ConfirmEmailDeliveryFailedData, ConfirmEmailDeliveryFailedError, ConfirmEmailDeliveryFailedResponse, ConfirmPersonCredentialRegistrationData, ConfirmPersonCredentialRegistrationError, ConfirmPersonCredentialRegistrationResponse, ConfirmSmsDeliveredData, ConfirmSmsDeliveredError, ConfirmSmsDeliveredResponse, ConfirmSmsDeliveryFailedData, ConfirmSmsDeliveryFailedError, ConfirmSmsDeliveryFailedResponse, ConsentOauth2ClientForCallerData, ConsentOauth2ClientForCallerError, ConsentOauth2ClientForCallerResponse, ContentNegotiationsTestingOnlyData, ContentNegotiationsTestingOnlyError, ContentNegotiationsTestingOnlyResponse, CreateApiKeyData, CreateApiKeyError, CreateApiKeyResponse, CreateOauth2ClientData, CreateOauth2ClientError, CreateOauth2ClientResponse, CreateOrganizationData, CreateOrganizationError, CreateOrganizationResponse, DeleteApiKeyData, DeleteApiKeyError, DeleteApiKeyResponse, DeleteCarData, DeleteCarError, DeleteCarResponse, DeleteImageData, DeleteImageError, DeleteImageResponse, DeleteOauth2ClientData, DeleteOauth2ClientError, DeleteOauth2ClientResponse, DeleteOrganizationAvatarData, DeleteOrganizationAvatarError, DeleteOrganizationAvatarResponse, DeleteOrganizationData, DeleteOrganizationError, DeleteOrganizationResponse, DeleteProfileAvatarData, DeleteProfileAvatarError, DeleteProfileAvatarResponse2, DeliverAuditData, DeliverAuditError, DeliverAuditResponse, DeliverUsageData, DeliverUsageError, DeliverUsageResponse, DestroyAllRepositoriesData, DestroyAllRepositoriesError, DestroyAllRepositoriesResponse, DisassociateCredentialMfaAuthenticatorForCallerData, DisassociateCredentialMfaAuthenticatorForCallerError, DisassociateCredentialMfaAuthenticatorForCallerResponse, DownloadImageData, DownloadImageError, DownloadImageResponse, DownloadStreamTestingOnlyError, DownloadStreamTestingOnlyResponse, DrainAllAuditsData, DrainAllAuditsError, DrainAllAuditsResponse, DrainAllEmailsData, DrainAllEmailsError, DrainAllEmailsResponse, DrainAllEventNotificationsData, DrainAllEventNotificationsError, DrainAllEventNotificationsResponse, DrainAllProvisioningsData, DrainAllProvisioningsError, DrainAllProvisioningsResponse, DrainAllSmsesData, DrainAllSmsesError, DrainAllSmsesResponse, DrainAllUsagesData, DrainAllUsagesError, DrainAllUsagesResponse, ErrorsErrorTestingOnlyError, ErrorsErrorTestingOnlyResponse, ErrorsThrowTestingOnlyError, ErrorsThrowTestingOnlyResponse, ExchangeOauth2ForTokensData, ExchangeOauth2ForTokensError, ExchangeOauth2ForTokensResponse, ExportSubscriptionsToMigrateData, ExportSubscriptionsToMigrateError, ExportSubscriptionsToMigrateResponse2, ForceCancelSubscriptionData, ForceCancelSubscriptionError, ForceCancelSubscriptionResponse, FormatsTestingOnlyData, FormatsTestingOnlyError, FormatsTestingOnlyResponse2, GetAllFeatureFlagsError, GetAllFeatureFlagsResponse2, GetCallerWithHmacTestingOnlyError, GetCallerWithHmacTestingOnlyResponse, GetCallerWithTokenOrApiKeyTestingOnlyError, GetCallerWithTokenOrApiKeyTestingOnlyResponse, GetCarData, GetCarError, GetCarResponse2, GetDiscoveryDocumentError, GetDiscoveryDocumentResponse2, GetFeatureFlagData, GetFeatureFlagError, GetFeatureFlagForCallerData, GetFeatureFlagForCallerError, GetFeatureFlagForCallerResponse, GetFeatureFlagResponse2, GetIdentityForCallerError, GetIdentityForCallerResponse, GetImageData, GetImageError, GetImageResponse2, GetInsecureTestingOnlyError, GetInsecureTestingOnlyResponse, GetJsonWebKeySetError, GetJsonWebKeySetResponse2, GetOauth2ClientConsentForCallerData, GetOauth2ClientConsentForCallerError, GetOauth2ClientConsentForCallerResponse, GetOauth2ClientData, GetOauth2ClientError, GetOauth2ClientResponse, GetOrganizationData, GetOrganizationError, GetOrganizationResponse2, GetOrganizationSettingsData, GetOrganizationSettingsError, GetOrganizationSettingsResponse2, GetPersonCredentialRegistrationConfirmationData, GetPersonCredentialRegistrationConfirmationError, GetPersonCredentialRegistrationConfirmationResponse2, GetProfileForCallerError, GetProfileForCallerResponse2, GetSubscriptionData, GetSubscriptionError, GetSubscriptionResponse2, GetTestingOnlyData, GetTestingOnlyError, GetTestingOnlyResponse, GetUserInfoForCallerError, GetUserInfoForCallerResponse2, GetWithRedirectTestingOnlyData, GetWithRedirectTestingOnlyError, GetWithRedirectTestingOnlyResponse, GetWithSimpleArrayTestingOnlyData, GetWithSimpleArrayTestingOnlyError, GetWithSimpleArrayTestingOnlyResponse, HealthCheckError, HealthCheckResponse2, InitiatePasswordResetData, InitiatePasswordResetError, InitiatePasswordResetResponse, InviteGuestData, InviteGuestError, InviteGuestResponse2, InviteMemberToOrganizationData, InviteMemberToOrganizationError, InviteMemberToOrganizationResponse2, ListCredentialMfaAuthenticatorsForCallerData, ListCredentialMfaAuthenticatorsForCallerError, ListCredentialMfaAuthenticatorsForCallerResponse2, ListMembersForOrganizationData, ListMembersForOrganizationError, ListMembersForOrganizationResponse2, ListMembershipsForCallerData, ListMembershipsForCallerError, ListMembershipsForCallerResponse2, ListPricingPlansError, ListPricingPlansResponse2, MakeBookingData, MakeBookingError, MakeBookingResponse2, MigrateSubscriptionPatchData, MigrateSubscriptionPatchError, MigrateSubscriptionPatchResponse, MigrateSubscriptionPutData, MigrateSubscriptionPutError, MigrateSubscriptionPutResponse, NotifyDomainEventData, NotifyDomainEventError, NotifyDomainEventResponse, NotifyFakeBillingProviderWebHookEventData, NotifyFakeBillingProviderWebHookEventError, NotifyFakeBillingProviderWebHookEventResponse, NotifyProvisioningData, NotifyProvisioningError, NotifyProvisioningResponse, OpenApiGetTestingOnlyData, OpenApiGetTestingOnlyError, OpenApiGetTestingOnlyResponse, OpenApiPostFormUrlEncodedTestingOnlyData, OpenApiPostFormUrlEncodedTestingOnlyError, OpenApiPostFormUrlEncodedTestingOnlyResponse, OpenApiPostMultiPartFormDataTestingOnlyData, OpenApiPostMultiPartFormDataTestingOnlyError, OpenApiPostMultiPartFormDataTestingOnlyResponse, OpenApiPostTestingOnlyData, OpenApiPostTestingOnlyError, OpenApiPostTestingOnlyResponse, OpenApiPutTestingOnlyPatchData, OpenApiPutTestingOnlyPatchError, OpenApiPutTestingOnlyPatchResponse, OpenApiPutTestingOnlyPutData, OpenApiPutTestingOnlyPutError, OpenApiPutTestingOnlyPutResponse, PostInsecureTestingOnlyData, PostInsecureTestingOnlyError, PostInsecureTestingOnlyResponse, PostTestingOnlyData, PostTestingOnlyError, PostTestingOnlyResponse, PostWithEmptyBodyAndRequiredPropertiesTestingOnlyData, PostWithEmptyBodyAndRequiredPropertiesTestingOnlyError, PostWithEmptyBodyAndRequiredPropertiesTestingOnlyResponse, PostWithEmptyBodyTestingOnlyData, PostWithEmptyBodyTestingOnlyError, PostWithEmptyBodyTestingOnlyResponse, PostWithRedirectTestingOnlyData, PostWithRedirectTestingOnlyError, PostWithRedirectTestingOnlyResponse, PostWithRouteParamsAndEmptyBodyTestingOnlyData, PostWithRouteParamsAndEmptyBodyTestingOnlyError, PostWithRouteParamsAndEmptyBodyTestingOnlyResponse, RecordMeasureData, RecordMeasureError, RecordMeasureResponse, RecordUseData, RecordUseError, RecordUseResponse, RefreshTokenData, RefreshTokenError, RefreshTokenResponse2, RegenerateOauth2ClientSecretData, RegenerateOauth2ClientSecretError, RegenerateOauth2ClientSecretResponse, RegisterCarData, RegisterCarError, RegisterCarResponse, RegisterMachineData, RegisterMachineError, RegisterMachineResponse2, RegisterPersonCredentialData, RegisterPersonCredentialError, RegisterPersonCredentialResponse2, RequestCorrelationsTestingOnlyError, RequestCorrelationsTestingOnlyResponse, ResendGuestInvitationData, ResendGuestInvitationError, ResendGuestInvitationResponse, ResendPasswordResetData, ResendPasswordResetError, ResendPasswordResetResponse, ResendPersonCredentialRegistrationConfirmationData, ResendPersonCredentialRegistrationConfirmationError, ResendPersonCredentialRegistrationConfirmationResponse, ResetCredentialMfaPatchData, ResetCredentialMfaPatchError, ResetCredentialMfaPatchResponse, ResetCredentialMfaPutData, ResetCredentialMfaPutError, ResetCredentialMfaPutResponse, RevokeApiKeyData, RevokeApiKeyError, RevokeApiKeyResponse, RevokeOauth2ClientConsentForCallerData, RevokeOauth2ClientConsentForCallerError, RevokeOauth2ClientConsentForCallerResponse, RevokeRefreshTokenData, RevokeRefreshTokenError, RevokeRefreshTokenResponse, ScheduleMaintenanceCarPatchData, ScheduleMaintenanceCarPatchError, ScheduleMaintenanceCarPatchResponse, ScheduleMaintenanceCarPutData, ScheduleMaintenanceCarPutError, ScheduleMaintenanceCarPutResponse, SearchAllApiKeysForCallerData, SearchAllApiKeysForCallerError, SearchAllApiKeysForCallerResponse, SearchAllAuditsData, SearchAllAuditsError, SearchAllAuditsResponse2, SearchAllAvailableCarsData, SearchAllAvailableCarsError, SearchAllAvailableCarsResponse, SearchAllBookingsData, SearchAllBookingsError, SearchAllBookingsResponse2, SearchAllCarsData, SearchAllCarsError, SearchAllCarsResponse2, SearchAllCarUnavailabilitiesData, SearchAllCarUnavailabilitiesError, SearchAllCarUnavailabilitiesResponse2, SearchAllEmailDeliveriesData, SearchAllEmailDeliveriesError, SearchAllEmailDeliveriesResponse2, SearchAllEventNotificationsData, SearchAllEventNotificationsError, SearchAllEventNotificationsResponse2, SearchAllOauth2ClientsData, SearchAllOauth2ClientsError, SearchAllOauth2ClientsResponse, SearchAllSmsDeliveriesData, SearchAllSmsDeliveriesError, SearchAllSmsDeliveriesResponse2, SearchSubscriptionHistoryData, SearchSubscriptionHistoryError, SearchSubscriptionHistoryResponse2, SearchTestingOnlyData, SearchTestingOnlyError, SearchTestingOnlyResponse2, SendEmailData, SendEmailError, SendEmailResponse, SendSmsData, SendSmsError, SendSmsResponse, StatusesDeleteTestingOnlyError, StatusesDeleteTestingOnlyResponse, StatusesDeleteWithResponseTestingOnlyError, StatusesDeleteWithResponseTestingOnlyResponse, StatusesGetTestingOnlyError, StatusesGetTestingOnlyResponse, StatusesPostTestingOnlyData, StatusesPostTestingOnlyError, StatusesPostTestingOnlyResponse, StatusesPostWithLocationTestingOnlyData, StatusesPostWithLocationTestingOnlyError, StatusesPostWithLocationTestingOnlyResponse, StatusesPutPatchTestingOnlyPatchData, StatusesPutPatchTestingOnlyPatchError, StatusesPutPatchTestingOnlyPatchResponse, StatusesPutPatchTestingOnlyPutData, StatusesPutPatchTestingOnlyPutError, StatusesPutPatchTestingOnlyPutResponse, StatusesSearchTestingOnlyError, StatusesSearchTestingOnlyResponse, TakeOfflineCarPatchData, TakeOfflineCarPatchError, TakeOfflineCarPatchResponse, TakeOfflineCarPutData, TakeOfflineCarPutError, TakeOfflineCarPutResponse, TransferSubscriptionPatchData, TransferSubscriptionPatchError, TransferSubscriptionPatchResponse, TransferSubscriptionPutData, TransferSubscriptionPutError, TransferSubscriptionPutResponse, UnassignPlatformRolesPatchData, UnassignPlatformRolesPatchError, UnassignPlatformRolesPatchResponse, UnassignPlatformRolesPutData, UnassignPlatformRolesPutError, UnassignPlatformRolesPutResponse, UnassignRolesFromOrganizationPatchData, UnassignRolesFromOrganizationPatchError, UnassignRolesFromOrganizationPatchResponse, UnassignRolesFromOrganizationPutData, UnassignRolesFromOrganizationPutError, UnassignRolesFromOrganizationPutResponse, UnInviteMemberFromOrganizationData, UnInviteMemberFromOrganizationError, UnInviteMemberFromOrganizationResponse2, UpdateImagePatchData, UpdateImagePatchError, UpdateImagePatchResponse, UpdateImagePutData, UpdateImagePutError, UpdateImagePutResponse, UpdateOauth2ClientPatchData, UpdateOauth2ClientPatchError, UpdateOauth2ClientPatchResponse, UpdateOauth2ClientPutData, UpdateOauth2ClientPutError, UpdateOauth2ClientPutResponse, UploadImageData, UploadImageError, UploadImageResponse2, ValidationsUnvalidatedTestingOnlyData, ValidationsUnvalidatedTestingOnlyError, ValidationsUnvalidatedTestingOnlyResponse, ValidationsValidatedGetTestingOnlyData, ValidationsValidatedGetTestingOnlyError, ValidationsValidatedGetTestingOnlyResponse, ValidationsValidatedPostTestingOnlyData, ValidationsValidatedPostTestingOnlyError, ValidationsValidatedPostTestingOnlyResponse, VerifyCredentialMfaAuthenticatorForCallerPatchData, VerifyCredentialMfaAuthenticatorForCallerPatchError, VerifyCredentialMfaAuthenticatorForCallerPatchResponse, VerifyCredentialMfaAuthenticatorForCallerPutData, VerifyCredentialMfaAuthenticatorForCallerPutError, VerifyCredentialMfaAuthenticatorForCallerPutResponse, VerifyGuestInvitationData, VerifyGuestInvitationError, VerifyGuestInvitationResponse2, VerifyPasswordResetData, VerifyPasswordResetError, VerifyPasswordResetResponse } from './types.gen';
 ...
 */
export const deliverAudit = <ThrowOnError extends boolean = false>(
  options?: Options<DeliverAuditData, ThrowOnError>
) =>
 ...
 */
export const confirmPersonCredentialRegistration = <ThrowOnError extends boolean = false>(
  options?: Options<ConfirmPersonCredentialRegistrationData, ThrowOnError>
) =>
  (options?.client ?? client).post<
 ...
 */
export const getPersonCredentialRegistrationConfirmation = <ThrowOnError extends boolean = false>(
  options: Options<GetPersonCredentialRegistrationConfirmationData, ThrowOnError>
) =>
  (options?.client ?? client).get<
 ...
 */
export const resendPersonCredentialRegistrationConfirmation = <ThrowOnError extends boolean = false>(
  options?: Options<ResendPersonCredentialRegistrationConfirmationData, ThrowOnError>
) =>
  (options?.client ?? client).post<
 ...
 */
export const notifyFakeBillingProviderWebHookEvent = <ThrowOnError extends boolean = false>(
  options?: Options<NotifyFakeBillingProviderWebHookEventData, ThrowOnError>
) =>
  (options?.client ?? client).post<
    NotifyFakeBillingProviderWebHookEventResponse,
    NotifyFakeBillingProviderWebHookEventError,
    ThrowOnError
  >({
    ...options,
 ...
 */
export const getIdentityForCaller = <ThrowOnError extends boolean = false>(
 ...
 */
export const getUserInfoForCaller = <ThrowOnError extends boolean = false>(
  options?: Options<unknown, ThrowOnError>
) =>
 ...
 */
export const getDiscoveryDocument = <ThrowOnError extends boolean = false>(
  options?: Options<unknown, ThrowOnError>
) =>
 ...
 */
export const authorizeByAnonymousTestingOnly = <ThrowOnError extends boolean = false>(
  options?: Options<unknown, ThrowOnError>
) =>
  (options?.client ?? client).get<
    AuthorizeByAnonymousTestingOnlyResponse,
    AuthorizeByAnonymousTestingOnlyError,
    ThrowOnError
  >({
    ...options,
 ...
 */
export const authorizeByTokenWithRoleTestingOnly = <ThrowOnError extends boolean = false>(
  options?: Options<unknown, ThrowOnError>
) =>
  (options?.client ?? client).get<
    AuthorizeByTokenWithRoleTestingOnlyResponse,
    AuthorizeByTokenWithRoleTestingOnlyError,
    ThrowOnError
  >({
    ...options,
 ...
 */
export const deliverUsage = <ThrowOnError extends boolean = false>(
  options?: Options<DeliverUsageData, ThrowOnError>
) =>
