...
[Trait("Category", "Unit")]
public class ConfirmPersonCredentialRegistrationRequestValidatorSpec
{
    private readonly ConfirmPersonCredentialRegistrationRequest _dto;
    private readonly ConfirmPersonCredentialRegistrationRequestValidator _validator;

    public ConfirmPersonCredentialRegistrationRequestValidatorSpec()
    {
        _validator = new ConfirmPersonCredentialRegistrationRequestValidator();
        _dto = new ConfirmPersonCredentialRegistrationRequest
        {
