...
partial interface ISubdomainModule
{
    ...
    /// </summary>
    Action<WebHostOptions, WebApplication, List<MiddlewareRegistration>> ConfigureMiddleware { get; }

    /// <summary>
    ///     Returns a function for registering additional dependencies into the dependency injection container
    /// </summary>
    Action<WebHostOptions, ConfigurationManager, IServiceCollection>? RegisterServices { get; }
}