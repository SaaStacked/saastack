  ...
  return (
    <Card>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-2xl">
        <Button className="rounded-full flex-col py-8" variant="secondary" navigateTo="/cars/search">
          <img
        ...
        <Button className="rounded-full flex-col py-8" variant="secondary" navigateTo="/bookings/reserve">
          <img
