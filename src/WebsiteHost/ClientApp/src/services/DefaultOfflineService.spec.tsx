...
import { DefaultOfflineService } from './DefaultOfflineService.tsx';
...
describe('DefaultOfflineService', () => {
  ...
  describe('onStatusChanged', () => {
    ...
    it('should call multiple callbacks when status changes', () => {
  ...
  describe('network event handling', () => {
    ...
    it('should update status to online when online event is fired', () => {
      // Start offline
      offlineCallback(new Event('offline'));
      expect(service.status).toBe('offline');
    ...
    it('should update status to offline when offline event is fired', () => {
  ...
  describe('periodic health check', () => {
    ...
    it('should update status to online when health check succeeds', async () => {
      // @ts-ignore
    ...
    it('should update status to offline when health check fails with non-ok response', async () => {
    ...
    it('should update status to offline when health check throws error', async () => {
    ...
    it('should not change status when health check confirms current online status', async () => {
      const callback = vi.fn();
      service.onStatusChanged(callback);
    ...
    it('should not change status when health check confirms current offline status', async () => {
      const callback = vi.fn();
      service.onStatusChanged(callback);
