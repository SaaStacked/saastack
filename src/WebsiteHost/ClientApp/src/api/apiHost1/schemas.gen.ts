...
export const ConfirmPersonCredentialRegistrationRequestSchema = {
    required: ['token'],
    type: 'object',
    properties: {
        token: {
...
export const DeliveredEmailSchema = {
    required: ['attempts', 'body', 'created', 'id', 'isDelivered', 'isDeliveryFailed', 'isSent', 'subject', 'tags', 'toDisplayName', 'toEmailAddress'],
    type: 'object',
    properties: {
        attempts: {
            type: 'array',
            items: {
                required: ['date', 'day', 'dayOfWeek', 'dayOfYear', 'hour', 'kind', 'millisecond', 'microsecond', 'nanosecond', 'minute', 'month', 'now', 'second', 'ticks', 'timeOfDay', 'today', 'year', 'utcNow'],
                type: 'string',
                format: 'date-time'
            }
        },
...
export const EventNotificationSchema = {
    required: ['data', 'eventType', 'id', 'metadataFullyQualifiedName', 'rootAggregateType', 'streamName', 'subscriberRef', 'version'],
    type: 'object',
    properties: {
        data: {
            type: 'string'
...
export const GetPersonCredentialRegistrationConfirmationResponseSchema = {
    required: ['token'],
    type: 'object',
    properties: {
        token: {
...
export const OpenIdConnectDiscoveryDocumentSchema = {
    required: ['authorizationEndpoint', 'claimsSupported', 'codeChallengeMethodsSupported', 'idTokenEncryptionAlgValuesSupported', 'idTokenSigningAlgValuesSupported', 'issuer', 'jwksUri', 'registrationEndPoint', 'responseTypesSupported', 'scopesSupported', 'subjectTypesSupported', 'tokenEndpoint', 'tokenEndpointAuthMethodsSupported', 'tokenEndpointAuthSigningAlgValuesSupported', 'userInfoEncryptionAlgValuesSupported', 'userInfoEndpoint', 'userInfoSigningAlgValuesSupported'],
    type: 'object',
    properties: {
...
export const ResendPersonCredentialRegistrationConfirmationRequestSchema = {
    required: ['token'],
    type: 'object',
    properties: {
        token: {
...
export const SubscriptionWithPlanSchema = {
    required: ['buyerId', 'buyerReference', 'canBeCanceled', 'canBeUnsubscribed', 'id', 'invoice', 'owningEntityId', 'paymentMethod', 'period', 'plan', 'providerState', 'status'],
    type: 'object',
    properties: {
        buyerId: {
            type: 'string'
...
export const TwilioMessageStatusSchema = {
    enum: ['Unknown', 'queued', 'sending', 'sent', 'failed', 'delivered', 'undelivered', 'receiving', 'received', 'accepted', 'scheduled', 'read', 'canceled'],
    type: 'string'
} as const;
...
export const UserProfileForCallerSchema = {
    required: ['address', 'classification', 'defaultOrganizationId', 'displayName', 'features', 'id', 'isAuthenticated', 'name', 'roles', 'userId'],
    type: 'object',
    properties: {
        address: {
            '$ref': '#/components/schemas/ProfileAddress'
