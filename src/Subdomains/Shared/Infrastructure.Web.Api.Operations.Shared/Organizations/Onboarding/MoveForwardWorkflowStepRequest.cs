...
/// <summary>
///     Moves forward in the onboarding workflow, either to specified step, or to the next step.
...
/// </summary>
/// <response code="405">The current step is the last step. Or, the workflow has been completed</response>
