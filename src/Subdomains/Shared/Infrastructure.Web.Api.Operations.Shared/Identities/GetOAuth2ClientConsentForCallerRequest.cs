...
/// <summary>
///     Gets the user's consent for an OAuth2/Open ID Connect client
/// </summary>
...
public class
    GetOAuth2ClientConsentForCallerRequest : UnTenantedGetRequest<GetOAuth2ClientConsentForCallerRequest,
