...
public class SinglePlanBillingStateInterpreterSpec
{
    ...
    public void WhenGetBillingSubscriptionAndUnsubscribed_ThenAlwaysReturnsEmptySubscription()
    {
        ...
        result.Value.Plan.Trial.Should().BeNone();
        ...
        result.Value.UpcomingInvoice.CurrencyCode.Currency.Should().Be(CurrencyCodes.Default);
        result.Value.UpcomingInvoice.NextUtc.Should().BeNone();
        result.Value.UpcomingInvoice.Amount.Should().Be(0);
